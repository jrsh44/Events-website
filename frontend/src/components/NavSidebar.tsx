...
export const NavSidebar = () => {
  ...
  return (
    <div className="absolute top-0 bottom-0 z-10 flex sm:relative bg-background ">
      <nav
        className={`flex flex-col gap-10 items-center p-10 w-[100vw] flex-1 sm:w-[300px] border-r border-neutral-600 transition-transform duration-300 ${
      ...
      >
        ...
        <div className="flex gap-3 mt-auto items-center self-start">
          <UserIcon
            size={48}
      ...
      <button
        ...
        className={`absolute z-10 top-1/2 transform -translate-y-1/2 -translate-x-1/2 bg-neutral-800 text-neutral-300 p-2 rounded-full shadow-lg shadow-neutral-950 transition-all duration-300 ${
          isSidebarVisible ? "left-[95vw] sm:left-[300px]" : "left-2"
        }`}
      >
